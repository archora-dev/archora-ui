// Тени sm/md/lg соответствуют --elev-1/2/3 в theme.css (тёмная тема).
// --arch-shadow-focus ссылается на var(--ring-focus); кольцо привязано к
// фону темы, поэтому focus задан для каждой темы отдельно.
// Значения тут — TS-эквиваленты дефолтной (тёмной) темы.
export const shadows = {
  ...
  focus: {
    dark: "0 0 0 2px #0a0c10, 0 0 0 4px #7c6dff",
    light: "0 0 0 2px #fafbfc, 0 0 0 4px #7c6dff"
  }
} as const;
